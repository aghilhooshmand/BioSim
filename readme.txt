...
4- run :  localhost:8501 (it depends on port mentioned in docker compose file)
5- or for commandline run : docker-compose run biosim_cmd data_source.csv data_target.csv data_column_pairs.csv [max_pair] [max_row_for_similarity]
